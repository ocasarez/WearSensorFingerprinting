...
import com.oscarcasarezruiz.wearsensorfingerprinting.presenter.SensorDataActivityPresenter;
...
public class SensorDataActivity extends WearableActivity implements SensorDataActivityPresenter.View, View.OnClickListener, SensorEventListener2 {
    ...
    private void stopDataCollection() {
        ...
        StorageReference sensorDataRef = mStorageReference.child("wear-sensordata/measurements/" + sensorDataFile.getLastPathSegment());
